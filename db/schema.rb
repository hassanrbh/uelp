...
ActiveRecord::Schema[7.0].define(version: 20_220_730_134_310) do
  ...
  create_table 'answers', force: :cascade do |t|
    ...
    t.index %w[answer question_id], name: 'index_answers_on_answer_and_question_id', unique: true
    t.index %w[answer user_id question_id], name: 'index_answers_on_answer_and_user_id_and_question_id',
                                            unique: true
    t.index %w[answer user_id], name: 'index_answers_on_answer_and_user_id', unique: true
  ...
  create_table 'login_activities', force: :cascade do |t|
    ...
    t.index %w[user_type user_id], name: 'index_login_activities_on_user'
  end
  ...
  create_table 'questions', force: :cascade do |t|
    ...
    t.index %w[community_id question], name: 'index_questions_on_community_id_and_question', unique: true
  ...
  create_table 'shares', force: :cascade do |t|
    ...
    t.index %w[to user_id note], name: 'index_shares_on_to_and_user_id_and_note', unique: true
