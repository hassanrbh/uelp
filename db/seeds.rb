...
business = Business.new(
  ...
  web_address: Faker::Internet.url(host: `faker`, path: "fake_test_path_#{0 + 1}", scheme: 'https')
)
...
10.times do |j|
  ...
  menu.images.attach(io: File.open(Rails.root.join('db', 'sample', 'dishes', "dishe_#{j + 1}.jpg")),
                     filename: menu.name)
  menu.save!
end
