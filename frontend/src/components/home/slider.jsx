    ...
    <div className="flex flex-col group" key={idx}>
      ...
      <div className="mt-2">
        <div className="flex justify-between">
          ...
          <div className="flex">
            <p className="font-bold text-green-400 cursor-pointer text-sm mr-[2px]">{business.profile.price_info.average}</p>
        ...
        <div className="flex justify-between">
          <Tippy content={<span className="font-bold text-teal-400">Contact Me :)</span>} interactive={true} animation="scale">
